...
export const metadata = {
    ...
    title: 'Инсульт — диагностика, лечение и госпитализация в Москве',
    description: 'Экстренная помощь при инсульте, нейрореабилитация и восстановление. Платная госпитализация в клиники Москвы без очередей, подбор специалистов.',
